...
$#ARGV==4 or die "usage: shannon_ratchet.pl symbol initialcash tradingcost\n";

($symbol, $initialcash,$tradecost, $from, $to) = @ARGV;
...
open(STOCK, "get_data.pl --close --from=\"$from\" --to=\"$to\" $symbol |");
